...
import {donutChartData, scatterPlotData, barGraphData, otherInfo} from './data/Data'; //Contains chart data
import Heading from './Components/Header'; //contains header part
